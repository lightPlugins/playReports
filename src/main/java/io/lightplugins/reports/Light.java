package io.lightplugins.reports;

import com.zaxxer.hikari.HikariDataSource;
import io.lightplugins.reports.modules.reports.LightReports;
import io.lightplugins.reports.util.*;
import io.lightplugins.reports.util.database.SQLDatabase;
import io.lightplugins.reports.util.database.impl.MySQLDatabase;
import io.lightplugins.reports.util.database.impl.SQLiteDatabase;
import io.lightplugins.reports.util.database.model.ConnectionProperties;
import io.lightplugins.reports.util.database.model.DatabaseCredentials;
import io.lightplugins.reports.util.interfaces.LightModule;
import io.lightplugins.reports.util.manager.FileManager;
import io.lightplugins.reports.util.manager.MultiFileManager;
import io.lightplugins.reports.util.manager.PlaceholderManager;
...
public class Light extends JavaPlugin {
    ...
    private LightReports lightBank;
    ...
    public final static String consolePrefix = "§r[light§eReports§r] §r";
    public final String pluginName = "lightReports";
    ...
    private void initModules() {
        this.lightBank = new LightReports();
